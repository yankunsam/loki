...
type GetObjectRefRequest struct {
	From    github_com_prometheus_common_model.Time `protobuf:"varint,1,opt,name=from,proto3,customtype=github.com/prometheus/common/model.Time" json:"from"`
	Through github_com_prometheus_common_model.Time `protobuf:"varint,2,opt,name=through,proto3,customtype=github.com/prometheus/common/model.Time" json:"through"`
}

func (m *GetObjectRefRequest) Reset()      { *m = GetObjectRefRequest{} }
func (*GetObjectRefRequest) ProtoMessage() {}
func (*GetObjectRefRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_33a7bd4603d312b2, []int{14}
}
func (m *GetObjectRefRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetObjectRefRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetObjectRefRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetObjectRefRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetObjectRefRequest.Merge(m, src)
}
func (m *GetObjectRefRequest) XXX_Size() int {
	return m.Size()
}
func (m *GetObjectRefRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetObjectRefRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetObjectRefRequest proto.InternalMessageInfo

type GetObjectRefResponse struct {
	Refs []string `protobuf:"bytes,1,rep,name=refs,proto3" json:"refs,omitempty"`
}

func (m *GetObjectRefResponse) Reset()      { *m = GetObjectRefResponse{} }
func (*GetObjectRefResponse) ProtoMessage() {}
func (*GetObjectRefResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_33a7bd4603d312b2, []int{15}
}
func (m *GetObjectRefResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetObjectRefResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetObjectRefResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetObjectRefResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetObjectRefResponse.Merge(m, src)
}
func (m *GetObjectRefResponse) XXX_Size() int {
	return m.Size()
}
func (m *GetObjectRefResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetObjectRefResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetObjectRefResponse proto.InternalMessageInfo

func (m *GetObjectRefResponse) GetRefs() []string {
	if m != nil {
		return m.Refs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GetObjectRefRequest)(nil), "indexgatewaypb.GetObjectRefRequest")
	proto.RegisterType((*GetObjectRefResponse)(nil), "indexgatewaypb.GetObjectRefResponse")
}
...
var fileDescriptor_33a7bd4603d312b2 = []byte{
	...
	,
}
...
func (this *GetObjectRefRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetObjectRefRequest)
	if !ok {
		that2, ok := that.(GetObjectRefRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetObjectRefResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetObjectRefResponse)
	if !ok {
		that2, ok := that.(GetObjectRefResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetObjectRefRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&indexgatewaypb.GetObjectRefRequest{")
	s = append(s, "From: "+fmt.Sprintf("%#v", this.From)+",\n")
	s = append(s, "Through: "+fmt.Sprintf("%#v", this.Through)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GetObjectRefResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&indexgatewaypb.GetObjectRefResponse{")
	s = append(s, "Refs: "+fmt.Sprintf("%#v", this.Refs)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type IndexGatewayClient interface {
	...
	GetObjectRef(ctx context.Context, in *GetObjectRefRequest, opts ...grpc.CallOption) (*GetObjectRefResponse, error)
}
...
func (c *indexGatewayClient) GetObjectRef(ctx context.Context, in *GetObjectRefRequest, opts ...grpc.CallOption) (*GetObjectRefResponse, error) {
	out := new(GetObjectRefResponse)
	err := c.cc.Invoke(ctx, "/indexgatewaypb.IndexGateway/GetObjectRef", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IndexGatewayServer interface {
	...
	GetObjectRef(context.Context, *GetObjectRefRequest) (*GetObjectRefResponse, error)
}
...
func (*UnimplementedIndexGatewayServer) GetObjectRef(ctx context.Context, req *GetObjectRefRequest) (*GetObjectRefResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetObjectRef not implemented")
}
...
func _IndexGateway_GetObjectRef_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetObjectRefRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IndexGatewayServer).GetObjectRef(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/indexgatewaypb.IndexGateway/GetObjectRef",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndexGatewayServer).GetObjectRef(ctx, req.(*GetObjectRefRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IndexGateway_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetObjectRef",
			Handler:    _IndexGateway_GetObjectRef_Handler,
		},
	},
...
func (m *GetObjectRefRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetObjectRefRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetObjectRefRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetObjectRefResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetObjectRefResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetObjectRefResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Refs) > 0 {
		for iNdEx := len(m.Refs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintGateway(dAtA, i, uint64(len(m.Refs[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *GetObjectRefRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetObjectRefResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GetObjectRefRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetObjectRefRequest{`,
		`From:` + fmt.Sprintf("%v", this.From) + `,`,
		`Through:` + fmt.Sprintf("%v", this.Through) + `,`,
		`}`,
	}, "")
...
func (this *GetObjectRefResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetObjectRefResponse{`,
...
func (m *GetObjectRefRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetObjectRefRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetObjectRefRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GetObjectRefResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetObjectRefResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetObjectRefResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
